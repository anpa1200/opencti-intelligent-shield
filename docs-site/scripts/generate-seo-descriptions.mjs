...
const curatedDescriptions = {
  'intelligent-shield.md': 'Deploy OpenCTI as a structured CTI platform with STIX 2.1 feeds, ATT&CK relationships, Claude enrichment, hardened services, and investigation workflows.',
};
